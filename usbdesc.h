...
#define EP2_BUFF_SIZE 32
#define EP1_BUFF_SIZE 32
...
#define SERIAL_PORT_MAX_SPEED EP1_BUFF_SIZE*1000   
    
static const char dev_qualifier[]={
    0x0A,   
    0x06, 
    0x02, 0x00, 
    0xFF, 
...
static const uint8_t strSerial[] = {
    sizeof(strSerial),
    0x03,
    USB_UNICODE('G'),
    USB_UNICODE('a'),
